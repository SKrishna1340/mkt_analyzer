...
`mkt_analyzer` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/mkt_analyzer
[issue tracker]: https://github.com/<USERNAME>/mkt_analyzer/issues
